...
Here is the full, revised documentation for the KYC endpoint, incorporating the concise `500 Internal Server Error` message you requested.

-----

### POST `/kyc` (or equivalent endpoint)
