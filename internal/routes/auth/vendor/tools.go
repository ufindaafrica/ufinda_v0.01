...
// <-------------------------> Begin Error Tools <---------------------------->
var ErrorGettingPendingVendor = errors.New("Failed to get pending user")
var ErrorGettingVendor = errors.New("Failed to get user")
var ErrorVendorNotFound = errors.New("no user found")
var ErrorPendingVendorNotFound = errors.New("no pending user found")
var InvalidRequest = "invralid request"
// <-------------------------> End Error Tools <---------------------------->
...
func InsertPendingUser(pendinguser *db.PendingUser) error {
	...
	endpoint := fmt.Sprintf("/rest/v1/pending_vendors")
